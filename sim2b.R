##########################################################################
####  Optimal Reinsurance Multivariate: Simulation Study 2 (Case 2)   ####
##########################################################################
...
print(summary_df)
c(mean(VaR_qs_vec-VaR_sl_vec,na.rm=T)-1.96*sd(VaR_qs_vec-VaR_sl_vec,na.rm=T),
  mean(VaR_qs_vec-VaR_sl_vec,na.rm=T)+1.96*sd(VaR_qs_vec-VaR_sl_vec,na.rm=T))
## actual vs estimated 
...
###############################################################################
save(c_mat, d_mat, VaR_qs_vec, VaR_sl_vec, boot_sd_mat, file="sim2b_3.Rda")
